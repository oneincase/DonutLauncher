...
contextBridge.exposeInMainWorld('donut', {
  ...
  getVersion: () => ipcRenderer.invoke('donut:getVersion'),
  checkUpdate: () => ipcRenderer.invoke('donut:checkUpdate'),
  openExternal: (url) => ipcRenderer.invoke('donut:openExternal', url),
